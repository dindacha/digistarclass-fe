// src/api/expenseItemApi.js
import axios from 'axios';

const API_URL = 'https://digistar-demo-be.vercel.app/api/expense-items';
...
// POST
export const createExpenseItem = async (itemData) => {
  try {
...
// PUT
export const updateExpenseItem = async (id, updatedData) => {
  try {
